...
-- =========================== 게시글 데이터 =======================================
insert into `riding_the_wind`.article(`article_no`, `member_id`, `subject`, `content`,`hit`, `like`, `register_time`, `modify_time`) value(1, 'yuhojae', '주말 맛집나들이~~','저번주 토요일은 이번달 다이어트로 고생한 제게 휴식을 주는 치팅데이였어요! 토요일에 다닌 맛집들을 소개할게요~~
...
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(1,232225,3);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(1,562471,4);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(1,1897611,1);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(1,1998333,0);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(1,2663380,2);


insert into `riding_the_wind`.article(`article_no`, `member_id`, `subject`, `content`,`hit`, `like`, `register_time`, `modify_time`) value(2, 'baeyonghyun', '종로 맛집명소!!','저번주 토요일은 이번달 다이어트로 고생한 제게 휴식을 주는 치팅데이였어요! 토요일에 다닌 맛집들을 소개할게요~~
...
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(2,232225,3);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(2,562471,4);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(2,1897611,1);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(2,1998333,0);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(2,2663380,2);


insert into `riding_the_wind`.article(`article_no`, `member_id`, `subject`, `content`,`hit`, `like`, `register_time`, `modify_time`) value(3, 'dragon', '서울 여행지 경로추천해요~','저번주 토요일은 이번달 다이어트로 고생한 제게 휴식을 주는 치팅데이였어요! 토요일에 다닌 맛집들을 소개할게요~~
...
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(3,232225,3);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(3,562471,4);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(3,1897611,1);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(3,1998333,0);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(3,2663380,2);

insert into `riding_the_wind`.article(`article_no`, `member_id`, `subject`, `content`,`hit`, `like`, `register_time`, `modify_time`) value(4, 'goodnews', '식탐로드 제 1편','저번주 토요일은 이번달 다이어트로 고생한 제게 휴식을 주는 치팅데이였어요! 토요일에 다닌 맛집들을 소개할게요~~
...
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(4,232225,3);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(4,562471,4);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(4,1897611,1);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(4,1998333,0);
insert into `riding_the_wind`.article_attraction_map(`article_no`,`content_id`,`order`) value(4,2663380,2);


-- ======================================== 댓글 데이터 =============================================
select * from comment;
insert into `riding_the_wind`.`comment`(`comment_no`, `article_no`, `member_id`, `content`, `register_time`) values(1, 1, 'yuhojae', '라크슌 저도 가봤는데 상당히 괜찮더라구요!', now());
insert into `riding_the_wind`.`comment`(`comment_no`, `article_no`, `member_id`, `content`, `register_time`) values(2, 1, 'baeyonghyun', '라크슌 별로던데', now());
insert into `riding_the_wind`.`comment`(`comment_no`, `article_no`, `member_id`, `content`, `register_time`) values(3, 1, 'dragon', '싸우지 마세요ㅠ', now());
insert into `riding_the_wind`.`comment`(`comment_no`, `article_no`, `member_id`, `content`, `register_time`) values(4, 1, 'goodnews', '배고프다', now());
